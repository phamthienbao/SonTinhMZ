...
CGMZ.Crafting.SceneTitle = CGMZ.Crafting.parameters["Scene Title"] || "Crafting";
...
CGMZ.Crafting.AutoScroll = (CGMZ.Crafting.parameters["Auto Scroll"] === "true") ? true : false;
...
CGMZ.Crafting.ShowLearnToast = (CGMZ.Crafting.parameters["Show Learn Toast"] === "true") ? true : false;
CGMZ.Crafting.ToastText = CGMZ.Crafting.parameters["Toast Text"] || "Learned Recipe: ";
CGMZ.Crafting.AlwaysAwardExp = (CGMZ.Crafting.parameters["Always Award Exp"] === "true") ? true : false;
CGMZ.Crafting.AlwaysShowRecipes = (CGMZ.Crafting.parameters["Always Show Recipes"] === "true") ? true : false;
//=============================================================================
// CGMZ_Recipe
//-----------------------------------------------------------------------------
...
CGMZ_Window_RecipeDisplay.prototype.refresh = function() {
	...
	y += this.lineHeight();
	this.drawRecipeStandardLine(CGMZ.Crafting.SuccessRateText + ": ", this._recipe._successRate + "%", firstLineX, y, width);
	y += this.lineHeight();
	...
	y = this.drawRecipeItems(CGMZ.Crafting.ProduceText, recipe._products, y, width, true);
	y = this.drawRecipeItems(CGMZ.Crafting.ToolsText, recipe._tools, y, width, false);
	y = this.drawRecipeItems(CGMZ.Crafting.IngredientsText, recipe._ingredients, y, width, false);
...
// Draw Item Lists
//-----------------------------------------------------------------------------
CGMZ_Window_RecipeDisplay.prototype.drawRecipeItems = function(descriptorText, itemArray, yVal, width, product) {
	...
	for(let i = 0; i < itemArray.length; i++) {
		...
		if(item) {
			...
			var totalWidth = this.textWidth(amount) + this.textWidth(name) + ImageManager.iconWidth;
...
// Look up item
//-----------------------------------------------------------------------------
CGMZ_Window_RecipeDisplay.prototype.lookupItem = function(type, id) {
	switch(type) {
		case 'item':
			return $dataItems[id];
		case 'weapon':
		...
		default:
			$cgmzTemp.reportError("Item type setup incorrectly", "CGMZ Crafting", "Check Recipe Items");
			return null;
	}
};
//=============================================================================
